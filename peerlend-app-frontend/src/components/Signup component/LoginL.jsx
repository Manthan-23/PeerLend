...
const LoginL = () => {
    ...
    const handleLogin = (e) => {
        ...
        axios.post('http://localhost:3000/api/login-lend',
            {
                email: email,
                password: password
            })
                ...
                <div class="flex flex-col items-center justify-center px-6 py-8 md:h-screen lg:py-0">
                    ...
                    <div class="w-full bg-gray-100 rounded-lg md:mt-0 sm:max-w-md">
                        <div class="p-6 space-y-1 md:space-y-6 sm:p-8">
                            <h1 class="text-xl font-bold tracking-tight md:text-2xl mb-6">
                                Login as a Lenderer
                                
                            </h1>
                            {/* <h3 class="mb-5 text-md">Are you a Borrower? <Link to="/login-len"><a class="hover:underline">Login here</a></Link></h3> */}
